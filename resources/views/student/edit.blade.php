                ...
                <div class="col-md-8">
                    <div class="card w-100 bg-colour1">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('student.update',$student->std_id) }}">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="std_name" type="text" class="form-control @error('std_name') is-invalid @enderror" name="std_name" value="{{ $student['std_name'] }}" autocomplete="std_name" autofocus>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm text-justify text-left1">
                                                <button type="submit" class="btn btn-primary mb-4" href="#">Edit Student Profile</button>
                                            </div>
                                        </div>
                                    </div>
                            </form>
